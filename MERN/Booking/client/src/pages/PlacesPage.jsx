      ...
      {action === 'new' && (
        <div className="">
          <form>
            ...
            <p className="text-gray-500 text-sm">title for your place, be short and catchy</p>
            <input type="text" placeholder="title, i.e. Emerging Condo" />
            ...
            <p className="text-gray-500 text-sm">Show the best views</p>
